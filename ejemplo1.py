...
documents = [
  "La sangre de las llamas contiene una gran cantidad de hemoglobina, la proteína que transporta el oxígeno de los pulmones a todo el cuerpo, lo que les permite sobrevivir a gran altura con bajos niveles de oxígeno.",
